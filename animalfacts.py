...
NARWHAL_FACTS = (
    ...
    "there is roughly as much vitamin C in one ounce of narwhal skin as there is in one ounce of oranges. Narwhal skin is a primary source of vitamins for the Inuit people of the Arctic."
    )
